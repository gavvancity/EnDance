...
export default function SettingsPage() {
  return (
    <div style={{ fontFamily: 'sans-serif', minHeight: '100vh', background: '#fff', padding: '24px' }}>
      {/* Top bar */}
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: 24 }}>
        <Image
          src="C:\Users\AyOpt\OneDrive\Desktop\dynamic content design\components\images\image 8.png"
          alt="Profile"
          width={48}
          height={48}
