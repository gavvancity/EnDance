...
export default function TermsPage() {
  ...
  return (
    <div style={{ fontFamily: karla.style.fontFamily, background: '#000', minHeight: '100vh', padding: 0, margin: 0 }}>
      <div style={{ maxWidth: 430, margin: '0 auto', padding: '0 20px 32px 20px', minHeight: '100vh', background: '#fff', boxSizing: 'border-box' }}>
        ...
        <div style={{ fontWeight: 600, fontSize: 15, marginBottom: 18, color: '#000' }}>Last Updated: 2025-03-27</div>
        <div style={{ fontSize: 16, marginBottom: 18, color: '#000' }}>
        ...
        <div style={{ fontWeight: 700, fontSize: 18, margin: '18px 0 6px 0', color: '#000' }}>Eligibility</div>
        <ul style={{ fontSize: 16, marginTop: 0, color: '#000', marginBottom: 0 }}>
          <li>You must be at least 18 years old to use the App.</li>
        </ul>
        <div style={{ fontWeight: 700, fontSize: 18, margin: '18px 0 6px 0', color: '#000' }}>User Accounts</div>
        <ul style={{ fontSize: 16, marginTop: 0, color: '#000', marginBottom: 0 }}>
        ...
        <div style={{ fontWeight: 700, fontSize: 18, margin: '18px 0 6px 0', color: '#000' }}>Acceptable Use Users agree to:</div>
        <ul style={{ fontSize: 16, marginTop: 0, color: '#000', marginBottom: 0 }}>
          <li>Use the App only for lawful purposes.</li>
          <li>Respect the rights and privacy of other users.</li>
          <li>Refrain from posting misleading, offensive, or harmful content.</li>
        </ul>
        <div style={{ fontWeight: 700, fontSize: 18, margin: '18px 0 6px 0', color: '#000' }}>Prohibited activities include but are not limited to:</div>
        <ul style={{ fontSize: 16, marginTop: 0, color: '#000', marginBottom: 0 }}>
        ...
        <div style={{ fontWeight: 700, fontSize: 18, margin: '18px 0 6px 0', color: '#000' }}>Content Ownership and License</div>
        <ul style={{ fontSize: 16, marginTop: 0, color: '#000', marginBottom: 0 }}>
        ...
        <div style={{ fontWeight: 700, fontSize: 18, margin: '18px 0 6px 0', color: '#000' }}>Auditions, Jobs, and Third-Party Opportunities</div>
        <ul style={{ fontSize: 16, marginTop: 0, color: '#000', marginBottom: 0 }}>
        ...
        <div style={{ fontWeight: 700, fontSize: 18, margin: '18px 0 6px 0', color: '#000' }}>Payments and Subscriptions</div>
        <ul style={{ fontSize: 16, marginTop: 0, color: '#000', marginBottom: 0 }}>
        ...
        <div style={{ fontWeight: 700, fontSize: 18, margin: '18px 0 6px 0', color: '#000' }}>Termination of Account</div>
        <ul style={{ fontSize: 16, marginTop: 0, color: '#000', marginBottom: 0 }}>
        ...
        <div style={{ fontWeight: 700, fontSize: 18, margin: '18px 0 6px 0', color: '#000' }}>Disclaimers and Limitation of Liability</div>
        <ul style={{ fontSize: 16, marginTop: 0, color: '#000', marginBottom: 0 }}>
        ...
        <div style={{ fontWeight: 700, fontSize: 18, margin: '18px 0 6px 0', color: '#000' }}>Changes to These Terms</div>
        <ul style={{ fontSize: 16, marginTop: 0, color: '#000', marginBottom: 0 }}>
          <li>We may update these Terms periodically. Continued use of the App after updates means you accept the revised Terms.</li>
        </ul>
        <div style={{ fontWeight: 700, fontSize: 18, margin: '18px 0 6px 0', color: '#000' }}>11. Contact Information</div>
        <ul style={{ fontSize: 16, marginTop: 0, color: '#000', marginBottom: 0 }}>
